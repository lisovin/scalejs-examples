...
/*global define */
define('app/foobar/viewmodels/foobarViewModel',[
    'sandbox!foobar',
], function (
    sandbox
) {
...
/*global define */
/*jslint sloppy: true*/
define('app/foobar/bindings/foobarBindings',{
...
define('text!app/foobar/views/foobar.html',[],function () { return '<div id="foo_template">\n    <span data-bind="text: fooText"></span>\n</div>\n<div id="bar_template">\r\n    <span data-bind="text: barText"></span>\r\n</div>';});

define('css!app/foobar/styles/foobar',[],function(){});
/*global define */
define('app/foobar/foobarModule',[
    'sandbox!foobar',
